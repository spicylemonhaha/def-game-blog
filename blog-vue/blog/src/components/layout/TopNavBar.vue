<template>
  <v-app-bar app height="55" color="white" flat>
    <div class="d-md-none nav-mobile-container">
      <div style="font-size: 18px; font-weight: bold; color: #17a1ff">
        Def·Game
      </div>
    ...
    <div class="d-md-block d-none nav-container">
      <div class="float-left blog-title">
        <router-link style="color: #17a1ff" to="/"> Def·Game </router-link>
      </div>
      <div class="float-right nav-title">
        ...
        ></el-autocomplete>
        <div v-for="item in menus" :key="item.id" class="menus-item">
          <router-link :to="item.url">
            <i class="iconfont" :class="item.icon" /> {{ item.message }}
          </router-link>
        </div>
      </div>
    </div>
